...
#    Updated: 2024/04/26 10:11:54 by dicarval         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

NAME = libftprintf.a

SRCS_PF = ft_printf.c ft_format_type.c ft_print_char.c ft_print_digit.c ft_print_string.c

SRCS_LB = ft_isalpha.c ft_isdigit.c ft_isalnum.c ft_isascii.c ft_isprint.c \
...
.PHONY: all libft clean fclean re .c.o
